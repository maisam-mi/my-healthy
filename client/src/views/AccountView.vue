<template>
  <div class="column justify-center items-center robotoBold">
    <div class="text-center">
      ...
      <p v-if="editMode == false" class="text-h5">
      ...
      <p class="text-h6 robotoMedium">{{ store.person.email }}</p>
    </div>
    <div class="row q-gutter-md justify-center">
      <q-card class="q-pa-none my-card card text-center col-5">
        <q-card-section>
          <div>
      ...
      <q-card class="my-card card text-center col-5">
        <q-card-section>
          ...
          <div class="text-h6">
            <span v-if="store.person.time.hours != null"
              >{{ store.person.time.hours }} h&nbsp;</span
            >
            <span v-if="store.person.time.minutes != null"
              >{{ store.person.time.minutes }} min&nbsp;</span
            >
